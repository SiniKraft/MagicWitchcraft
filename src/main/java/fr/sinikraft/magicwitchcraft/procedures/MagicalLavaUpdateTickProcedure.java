...
public class MagicalLavaUpdateTickProcedure extends MagicWitchcraftModElements.ModElement {
	public MagicalLavaUpdateTickProcedure(MagicWitchcraftModElements instance) {
		super(instance, 183);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MagicWitchcraftMod.LOGGER.warn("Failed to load dependency x for procedure MagicalLavaUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				MagicWitchcraftMod.LOGGER.warn("Failed to load dependency y for procedure MagicalLavaUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MagicWitchcraftMod.LOGGER.warn("Failed to load dependency z for procedure MagicalLavaUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MagicWitchcraftMod.LOGGER.warn("Failed to load dependency world for procedure MagicalLavaUpdateTick!");
			return;
		}
		...
		if ((((((world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z))).getBlock() == MysteriousPortalBlock.block.getDefaultState()
								...
								.getBlock())))) {
			{
				...
				BlockState _bs = MagicalDimensionPortalBlock.block.getDefaultState();
