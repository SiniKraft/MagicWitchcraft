...
public class MagicalCompressorOnBlockRightClickedProcedure extends MagicWitchcraftModElements.ModElement {
	public MagicalCompressorOnBlockRightClickedProcedure(MagicWitchcraftModElements instance) {
		super(instance, 175);
	}
				...
				if (_ent instanceof ServerPlayerEntity) {
					...
					NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
						...
						public ITextComponent getDisplayName() {
							return new StringTextComponent("MagicalCompressorGUI");
						}

						@Override
						public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
							return new MagicalCompressorGUIGui.GuiContainerMod(id, inventory,
