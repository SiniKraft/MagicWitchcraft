...
public class MagicalCompressorActivateUpdateTickProcedure extends MagicWitchcraftModElements.ModElement {
	public MagicalCompressorActivateUpdateTickProcedure(MagicWitchcraftModElements instance) {
		super(instance, 176);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((!((new Object() {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(MagicalWheatItem.block, (int) (1))
					.getItem())) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (_ent != null) {
						final int _sltid = (int) (0);
						final ItemStack _setstack = new ItemStack(MagicalWheatItem.block, (int) (1));
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(MagicalBerriesItem.block, (int) (1))
					.getItem())) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (_ent != null) {
						final int _sltid = (int) (0);
						final ItemStack _setstack = new ItemStack(MagicalBerriesItem.block, (int) (1));
						_setstack.setCount((int) ((new Object() {
							public int getAmount(BlockPos pos, int sltid) {
								AtomicInteger _retval = new AtomicInteger(0);
								TileEntity _ent = world.getTileEntity(pos);
