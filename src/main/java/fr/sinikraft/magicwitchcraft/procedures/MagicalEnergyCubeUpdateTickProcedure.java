...
public class MagicalEnergyCubeUpdateTickProcedure extends MagicWitchcraftModElements.ModElement {
	public MagicalEnergyCubeUpdateTickProcedure(MagicWitchcraftModElements instance) {
		super(instance, 335);
	}
