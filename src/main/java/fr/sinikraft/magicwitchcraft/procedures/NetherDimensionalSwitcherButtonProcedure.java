...
public class NetherDimensionalSwitcherButtonProcedure extends MagicWitchcraftModElements.ModElement {
	public NetherDimensionalSwitcherButtonProcedure(MagicWitchcraftModElements instance) {
		super(instance, 105);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MagicWitchcraftMod.LOGGER.warn("Failed to load dependency entity for procedure NetherDimensionalSwitcherButton!");
			return;
		}
...
public class NetherDimensionalSwitcherButtonProcedure extends MagicWitchcraftModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure NetherDimensionalSwitcherButton!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (entity instanceof PlayerEntity) {
