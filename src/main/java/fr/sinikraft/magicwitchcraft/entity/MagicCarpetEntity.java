...
public class MagicCarpetEntity extends MagicWitchcraftModElements.ModElement {
	...
	public MagicCarpetEntity(MagicWitchcraftModElements instance) {
		super(instance, 26);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 0.001f)).build("magiccarpet")
						.setRegistryName("magiccarpet");
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new RandomWalkingGoal(this, 0));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				MagicCarpetEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
