...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureMagicCarpetEntityDies;
import fr.sinikraft.magicwitchcraft.ElementsMagicWitchcraft;

@ElementsMagicWitchcraft.ModElement.Tag
public class EntityMagicCarpet extends ElementsMagicWitchcraft.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Model_magic_carpet(), 0.5f) {
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(2, new EntityAITempt(this, 1, new ItemStack(Items.DIAMOND, (int) (1)).getItem(), false));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureMagicCarpetEntityDies.executeProcedure($_dependencies);
			}
		}
