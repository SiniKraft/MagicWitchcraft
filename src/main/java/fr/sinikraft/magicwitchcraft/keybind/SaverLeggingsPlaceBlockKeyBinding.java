...
import fr.sinikraft.magicwitchcraft.procedures.SaverLeggingsPlaceBlockOnKeyPressedProcedure;
import fr.sinikraft.magicwitchcraft.MagicWitchcraftModElements;
import fr.sinikraft.magicwitchcraft.MagicWitchcraftMod;

@MagicWitchcraftModElements.ModElement.Tag
public class SaverLeggingsPlaceBlockKeyBinding extends MagicWitchcraftModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SaverLeggingsPlaceBlockKeyBinding(MagicWitchcraftModElements instance) {
		super(instance, 243);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.saverleggingsplaceblock", GLFW.GLFW_KEY_Q, "key.categories.misc");
