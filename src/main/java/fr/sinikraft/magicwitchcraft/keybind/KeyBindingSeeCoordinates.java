...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureSeeCoordinatesOnKeyPressed;
...
public class KeyBindingSeeCoordinates extends ElementsMagicWitchcraft.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.seecoordinates", Keyboard.KEY_FUNCTION, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureSeeCoordinatesOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
