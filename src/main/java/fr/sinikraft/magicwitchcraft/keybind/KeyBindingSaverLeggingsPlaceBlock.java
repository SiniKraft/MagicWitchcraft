...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureSaverLeggingsPlaceBlockOnKeyPressed;
...
public class KeyBindingSaverLeggingsPlaceBlock extends ElementsMagicWitchcraft.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.saverleggingsplaceblock", Keyboard.KEY_COMMA, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureSaverLeggingsPlaceBlockOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
