...
public class ProcedureMagicalEnergyDumperOnBlockRightClicked extends ElementsMagicWitchcraft.ModElement {
	public ProcedureMagicalEnergyDumperOnBlockRightClicked(ElementsMagicWitchcraft instance) {
		super(instance, 328);
	}
