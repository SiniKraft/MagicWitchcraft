...
public class ProcedureNetherDimensionalSwitcherButton extends ElementsMagicWitchcraft.ModElement {
	public ProcedureNetherDimensionalSwitcherButton(ElementsMagicWitchcraft instance) {
		super(instance, 90);
	}
