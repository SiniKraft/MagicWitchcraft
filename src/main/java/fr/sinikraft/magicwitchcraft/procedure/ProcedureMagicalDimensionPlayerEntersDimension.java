...
public class ProcedureMagicalDimensionPlayerEntersDimension extends ElementsMagicWitchcraft.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure MagicalDimensionPlayerEntersDimension!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure MagicalDimensionPlayerEntersDimension!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure MagicalDimensionPlayerEntersDimension!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure MagicalDimensionPlayerEntersDimension!");
			return;
		}
		...
		if ((!(MagicWitchcraftVariables.WorldVariables.get(world).ismagicaldimensiongenerated))) {
			if (!world.isRemote) {
				...
				if (template != null) {
					BlockPos spawnTo = new BlockPos((int) (x - 49), (int) (y - 3), (int) (z - 88));
