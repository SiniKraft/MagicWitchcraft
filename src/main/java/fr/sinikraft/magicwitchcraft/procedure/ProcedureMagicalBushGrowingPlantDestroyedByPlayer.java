...
public class ProcedureMagicalBushGrowingPlantDestroyedByPlayer extends ElementsMagicWitchcraft.ModElement {
	public ProcedureMagicalBushGrowingPlantDestroyedByPlayer(ElementsMagicWitchcraft instance) {
		super(instance, 136);
	}
