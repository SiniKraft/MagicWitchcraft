...
import fr.sinikraft.magicwitchcraft.block.BlockMagicalEnergyDumper;
import fr.sinikraft.magicwitchcraft.block.BlockMagicalEnergyConduit;
import fr.sinikraft.magicwitchcraft.ElementsMagicWitchcraft;

@ElementsMagicWitchcraft.ModElement.Tag
public class ProcedureMagicalEnergyConduitUpdateTick extends ElementsMagicWitchcraft.ModElement {
	public ProcedureMagicalEnergyConduitUpdateTick(ElementsMagicWitchcraft instance) {
		super(instance, 330);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			if (((new Object() {
				...
				if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + 1)))).getBlock() == BlockMagicalEnergyConduit.block
						.getDefaultState().getBlock())
						|| ((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + 1)))).getBlock() == BlockMagicalEnergyDumper.block
								.getDefaultState().getBlock()))) {
					if (((new Object() {
						public double getValue(BlockPos pos, String tag) {
							TileEntity tileEntity = world.getTileEntity(pos);
				...
				if ((((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == BlockMagicalEnergyConduit.block
						.getDefaultState().getBlock())
						|| ((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == BlockMagicalEnergyDumper.block
								.getDefaultState().getBlock()))) {
					if (((new Object() {
						public double getValue(BlockPos pos, String tag) {
							TileEntity tileEntity = world.getTileEntity(pos);
