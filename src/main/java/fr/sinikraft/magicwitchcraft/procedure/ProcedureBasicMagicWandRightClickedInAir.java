...
public class ProcedureBasicMagicWandRightClickedInAir extends ElementsMagicWitchcraft.ModElement {
	public ProcedureBasicMagicWandRightClickedInAir(ElementsMagicWitchcraft instance) {
		super(instance, 28);
	}
