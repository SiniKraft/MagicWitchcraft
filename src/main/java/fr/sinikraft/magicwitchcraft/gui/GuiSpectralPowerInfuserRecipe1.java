...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureSpectralPowerInfuserRecipe1NextRecipeOnButtonClicked;
...
public class GuiSpectralPowerInfuserRecipe1 extends ElementsMagicWitchcraft.ModElement {
	public static int GUIID = 17;
	public static HashMap guistate = new HashMap();
	public GuiSpectralPowerInfuserRecipe1(ElementsMagicWitchcraft instance) {
		super(instance, 368);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 44, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(BlockTrollWater.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 44, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(BlockTrollWater.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(8, this.addSlotToContainer(new Slot(internal, 8, 116, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 152, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 8, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("magic_witchcraft:textures/spectralpowerinfuserrecipe1_ingredients.png"));
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Recipes - spectral power infuser", 7, 4, -1);
			this.fontRenderer.drawString("TNT mine", 34, 66, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 99, this.guiTop + 59, 67, 20, "Next recipe"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureSpectralPowerInfuserRecipe1NextRecipeOnButtonClicked.executeProcedure($_dependencies);
			}
		}
	}
