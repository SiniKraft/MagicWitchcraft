...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureSpectralPowerInfuserRecipe2NextRecipeOnButtonClicked;
...
public class GuiSpectralPowerInfuserRecipe2 extends ElementsMagicWitchcraft.ModElement {
	public static int GUIID = 18;
	public static HashMap guistate = new HashMap();
	public GuiSpectralPowerInfuserRecipe2(ElementsMagicWitchcraft instance) {
		super(instance, 370);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("magic_witchcraft:textures/spectralpowerinfuserrecipe2_ingredients.png"));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureSpectralPowerInfuserRecipe2NextRecipeOnButtonClicked.executeProcedure($_dependencies);
			}
		}
	}
