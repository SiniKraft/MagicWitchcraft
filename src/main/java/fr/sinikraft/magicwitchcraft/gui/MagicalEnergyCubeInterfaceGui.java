...
public class MagicalEnergyCubeInterfaceGui extends MagicWitchcraftModElements.ModElement {
	...
	public MagicalEnergyCubeInterfaceGui(MagicWitchcraftModElements instance) {
		super(instance, 333);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("magicalenergycubeinterface"));
	}
