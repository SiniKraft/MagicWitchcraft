...
public class GuiAutoBlockRemoverInterface extends ElementsMagicWitchcraft.ModElement {
	public static int GUIID = 9;
	public static HashMap guistate = new HashMap();
	public GuiAutoBlockRemoverInterface(ElementsMagicWitchcraft instance) {
		super(instance, 269);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 80, 39) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 134, 39) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemStorageModule.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			int si;
			int sj;
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Auto block remover", 43, 2, -1);
			this.fontRenderer.drawString("Tool", 79, 20, -6684673);
			this.fontRenderer.drawString("Storage", 16, 20, -256);
			this.fontRenderer.drawString("Module", 133, 20, -13369600);
		}
