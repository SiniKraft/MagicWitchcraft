...
import fr.sinikraft.magicwitchcraft.procedures.SpectralPowerInterfaceViewRecipesOnButtonClickedProcedure;
...
public class SpectralPowerInterfaceGui extends MagicWitchcraftModElements.ModElement {
	...
	public SpectralPowerInterfaceGui(MagicWitchcraftModElements instance) {
		super(instance, 208);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("spectralpowerinterface"));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 43, 12) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(SpectralOrbItem.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
		...
		if (buttonID == 0) {
			{
				...
				SpectralPowerInterfaceViewRecipesOnButtonClickedProcedure.executeProcedure($_dependencies);
			}
		}
	}
