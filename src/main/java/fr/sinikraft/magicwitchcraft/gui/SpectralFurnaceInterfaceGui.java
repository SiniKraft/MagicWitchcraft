...
public class SpectralFurnaceInterfaceGui extends MagicWitchcraftModElements.ModElement {
	...
	public SpectralFurnaceInterfaceGui(MagicWitchcraftModElements instance) {
		super(instance, 351);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("spectralfurnaceinterface"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 97, 30) {
				@Override
