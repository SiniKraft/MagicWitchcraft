...
public class GuiMagicalEnergyCubeInterface extends ElementsMagicWitchcraft.ModElement {
	public static int GUIID = 12;
	public static HashMap guistate = new HashMap();
	public GuiMagicalEnergyCubeInterface(ElementsMagicWitchcraft instance) {
		super(instance, 333);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Magical Energy cube", 43, 11, -1);
			this.fontRenderer.drawString("Energy stored :", 48, 27, -16738048);
			...
			}.getValue(new BlockPos((int) x, (int) y, (int) z), "EnergyStored")) + "", 34, 47, -16724992);
			this.fontRenderer.drawString("/ 10 000 MER", 88, 47, -13369549);
		}
