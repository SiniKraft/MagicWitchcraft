...
public class MysteriousExtractorGUIGui extends MagicWitchcraftModElements.ModElement {
	...
	public MysteriousExtractorGUIGui(MagicWitchcraftModElements instance) {
		super(instance, 78);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("mysterious_extractor_gui"));
	}
		...
		if (buttonID == 0) {
			{
				...
				MysteriousExtractorGUIViewRecipesOnButtonClickedProcedure.executeProcedure($_dependencies);
			}
		}
=======
import net.minecraft.util.text.ITextComponent;
...
public class MysteriousExtractorGUIGui extends MagicWitchcraftModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("magic_witchcraft:textures/mysterious_log.png"));
			this.blit(this.guiLeft + 6, this.guiTop + 29, 0, 0, 256, 256, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("magic_witchcraft:textures/arrow_gui.png"));
