...
public class MysteriousExtractorRecipe1Gui extends MagicWitchcraftModElements.ModElement {
	...
	public MysteriousExtractorRecipe1Gui(MagicWitchcraftModElements instance) {
		super(instance, 366);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("mysteriousextractorrecipe1"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 43, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			...
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 115, 57) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
