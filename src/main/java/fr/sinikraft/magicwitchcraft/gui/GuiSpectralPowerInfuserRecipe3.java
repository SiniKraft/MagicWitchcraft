...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureSpectralPowerInfuserRecipe3NextRecipeOnButtonClicked;
...
public class GuiSpectralPowerInfuserRecipe3 extends ElementsMagicWitchcraft.ModElement {
	public static int GUIID = 19;
	public static HashMap guistate = new HashMap();
	public GuiSpectralPowerInfuserRecipe3(ElementsMagicWitchcraft instance) {
		super(instance, 372);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("magic_witchcraft:textures/spectralpowerinfuserrecipe3_ingredients.png"));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureSpectralPowerInfuserRecipe3NextRecipeOnButtonClicked.executeProcedure($_dependencies);
			}
		}
	}
