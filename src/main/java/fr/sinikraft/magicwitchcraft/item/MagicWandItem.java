...
import fr.sinikraft.magicwitchcraft.procedures.MagicWandRightClickedInAirProcedure;
import fr.sinikraft.magicwitchcraft.itemgroup.MagicWitchCraftItemGroup;
import fr.sinikraft.magicwitchcraft.MagicWitchcraftModElements;

@MagicWitchcraftModElements.ModElement.Tag
public class MagicWandItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicwand")
	public static final Item block = null;
	public MagicWandItem(MagicWitchcraftModElements instance) {
		super(instance, 10);
	}
