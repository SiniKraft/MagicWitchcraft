...
public class ItemMagicalBottleEmpty extends ElementsMagicWitchcraft.ModElement {
	@GameRegistry.ObjectHolder("magic_witchcraft:magicalbottleempty")
	public static final Item block = null;
	public ItemMagicalBottleEmpty(ElementsMagicWitchcraft instance) {
		super(instance, 295);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("magic_witchcraft:magicalbottleempty", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(15);
			maxStackSize = 1;
			setUnlocalizedName("magicalbottleempty");
			setRegistryName("magicalbottleempty");
