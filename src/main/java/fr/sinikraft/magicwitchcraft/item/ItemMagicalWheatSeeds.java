...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureMagicalWheatSeedsRightClickedOnBlock;
import fr.sinikraft.magicwitchcraft.creativetab.TabMagicWitchCraft;
import fr.sinikraft.magicwitchcraft.ElementsMagicWitchcraft;

@ElementsMagicWitchcraft.ModElement.Tag
public class ItemMagicalWheatSeeds extends ElementsMagicWitchcraft.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("magic_witchcraft:magicalwheatseeds", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("magicalwheatseeds");
			setRegistryName("magicalwheatseeds");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureMagicalWheatSeedsRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
