...
public class FrozenOrbItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:frozenorb")
	public static final Item block = null;
	public FrozenOrbItem(MagicWitchcraftModElements instance) {
		super(instance, 16);
	}
