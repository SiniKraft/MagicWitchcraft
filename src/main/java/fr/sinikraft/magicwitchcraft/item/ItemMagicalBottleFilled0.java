...
public class ItemMagicalBottleFilled0 extends ElementsMagicWitchcraft.ModElement {
	@GameRegistry.ObjectHolder("magic_witchcraft:magicalbottlefilled0")
	public static final Item block = null;
	public ItemMagicalBottleFilled0(ElementsMagicWitchcraft instance) {
		super(instance, 297);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("magic_witchcraft:magicalbottlefilled0", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(15);
			maxStackSize = 1;
			setUnlocalizedName("magicalbottlefilled0");
