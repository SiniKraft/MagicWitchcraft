...
public class SaturationOrbItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:saturationorb")
	public static final Item block = null;
	public SaturationOrbItem(MagicWitchcraftModElements instance) {
		super(instance, 15);
	}
