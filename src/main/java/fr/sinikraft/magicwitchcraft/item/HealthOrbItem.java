...
public class HealthOrbItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:healthorb")
	public static final Item block = null;
	public HealthOrbItem(MagicWitchcraftModElements instance) {
		super(instance, 17);
	}
