...
public class MagicalWheatItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicalwheat")
	public static final Item block = null;
	public MagicalWheatItem(MagicWitchcraftModElements instance) {
		super(instance, 43);
	}
