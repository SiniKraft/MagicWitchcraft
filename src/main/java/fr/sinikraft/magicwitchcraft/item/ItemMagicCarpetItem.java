...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureMagicCarpetItemRightClickedOnBlock;
import fr.sinikraft.magicwitchcraft.creativetab.TabMagicWitchCraft;
import fr.sinikraft.magicwitchcraft.ElementsMagicWitchcraft;

@ElementsMagicWitchcraft.ModElement.Tag
public class ItemMagicCarpetItem extends ElementsMagicWitchcraft.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("magic_witchcraft:magiccarpetitem", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("magiccarpetitem");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureMagicCarpetItemRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
