...
public class BunkerOrbItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:bunkerorb")
	public static final Item block = null;
	public BunkerOrbItem(MagicWitchcraftModElements instance) {
		super(instance, 275);
	}
