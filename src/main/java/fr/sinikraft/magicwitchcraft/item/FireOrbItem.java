...
public class FireOrbItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:fireorb")
	public static final Item block = null;
	public FireOrbItem(MagicWitchcraftModElements instance) {
		super(instance, 14);
	}
