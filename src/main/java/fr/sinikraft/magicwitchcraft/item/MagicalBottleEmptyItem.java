...
public class MagicalBottleEmptyItem extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicalbottleempty")
	public static final Item block = null;
	public MagicalBottleEmptyItem(MagicWitchcraftModElements instance) {
		super(instance, 295);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MagicWitchCraftItemGroup.tab).maxDamage(15).rarity(Rarity.COMMON));
