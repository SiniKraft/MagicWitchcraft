...
import fr.sinikraft.magicwitchcraft.procedures.SpectralPowerInfuserUpdateTickItemInInventoryTickProcedure;
...
public class MagicalBottleFilled0Item extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicalbottlefilled0")
	public static final Item block = null;
	public MagicalBottleFilled0Item(MagicWitchcraftModElements instance) {
		super(instance, 297);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magicalbottlefilled0");
		}
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			}
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("itemstack", itemstack);
				SpectralPowerInfuserUpdateTickItemInInventoryTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
