...
import fr.sinikraft.magicwitchcraft.procedures.MagicalEnergyGeneratorUpdateTickProcedure;
import fr.sinikraft.magicwitchcraft.itemgroup.MagicWitchCraftItemGroup;
import fr.sinikraft.magicwitchcraft.gui.MagicalEnergyGeneratorInterfaceGui;
import fr.sinikraft.magicwitchcraft.MagicWitchcraftModElements;

@MagicWitchcraftModElements.ModElement.Tag
public class MagicalEnergyGeneratorBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicalenergygenerator")
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Magical energy generator");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new MagicalEnergyGeneratorInterfaceGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("magicalenergygenerator");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new MagicalEnergyGeneratorInterfaceGui.GuiContainerMod(id, player,
