...
public class SaverBlockYellowBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:saverblockyellow")
	public static final Block block = null;
	public SaverBlockYellowBlock(MagicWitchcraftModElements instance) {
		super(instance, 356);
	}
