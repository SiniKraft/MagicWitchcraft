...
public class MagicalLogBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicallog")
	public static final Block block = null;
	public MagicalLogBlock(MagicWitchcraftModElements instance) {
		super(instance, 61);
	}
