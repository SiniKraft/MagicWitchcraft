...
import fr.sinikraft.magicwitchcraft.procedures.MagicalGrassEntityWalksOnTheBlockProcedure;
import fr.sinikraft.magicwitchcraft.itemgroup.MagicWitchCraftItemGroup;
import fr.sinikraft.magicwitchcraft.MagicWitchcraftModElements;

@MagicWitchcraftModElements.ModElement.Tag
public class MagicalGrassBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicalgrass")
	public static final Block block = null;
	public MagicalGrassBlock(MagicWitchcraftModElements instance) {
		super(instance, 57);
	}
...
>>>>>>> branch '1.15.2-master' of https://github.com/SiniKraft/MagicWitchcraft
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MagicalDirtBlock.block, (int) (1)));
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				MagicalGrassEntityWalksOnTheBlockProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
