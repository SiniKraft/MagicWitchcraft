...
public class BlockPurpleObsidian extends ElementsMagicWitchcraft.ModElement {
	@GameRegistry.ObjectHolder("magic_witchcraft:purpleobsidian")
	public static final Block block = null;
	public BlockPurpleObsidian(ElementsMagicWitchcraft instance) {
		super(instance, 73);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("purpleobsidian"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("magic_witchcraft:purpleobsidian", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("purpleobsidian");
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedurePurpleObsidianBlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onBlockDestroyedByExplosion(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedurePurpleObsidianBlockDestroyedByExplosion.executeProcedure($_dependencies);
			}
		}
	}
}
