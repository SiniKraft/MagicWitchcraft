...
public class MysteriousLogBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:mysterious_log")
	public static final Block block = null;
	public MysteriousLogBlock(MagicWitchcraftModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mysterious_log");
		}
