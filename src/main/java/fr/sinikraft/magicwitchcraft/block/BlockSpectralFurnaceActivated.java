...
public class BlockSpectralFurnaceActivated extends ElementsMagicWitchcraft.ModElement {
	@GameRegistry.ObjectHolder("magic_witchcraft:spectralfurnaceactivated")
	public static final Block block = null;
	public BlockSpectralFurnaceActivated(ElementsMagicWitchcraft instance) {
		super(instance, 352);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("spectralfurnaceactivated"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "magic_witchcraft:tileentityspectralfurnaceactivated");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("magic_witchcraft:spectralfurnaceactivated", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("spectralfurnaceactivated");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.spectralfurnaceactivated";
		}
		...
		public String getGuiID() {
			return "magic_witchcraft:spectralfurnaceactivated";
		}
