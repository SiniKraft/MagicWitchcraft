...
import fr.sinikraft.magicwitchcraft.procedure.ProcedureMysteriousOrbOreBlockDestroyedByPlayer;
...
public class BlockMysteriousOrbOre extends ElementsMagicWitchcraft.ModElement {
	@GameRegistry.ObjectHolder("magic_witchcraft:mysterious_orb_ore")
	public static final Block block = null;
	public BlockMysteriousOrbOre(ElementsMagicWitchcraft instance) {
		super(instance, 3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mysterious_orb_ore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("magic_witchcraft:mysterious_orb_ore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureMysteriousOrbOreBlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
