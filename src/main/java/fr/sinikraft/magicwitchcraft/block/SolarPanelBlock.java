...
import fr.sinikraft.magicwitchcraft.procedures.SolarPanelUpdateTickProcedure;
import fr.sinikraft.magicwitchcraft.itemgroup.MagicWitchCraftItemGroup;
import fr.sinikraft.magicwitchcraft.gui.SolarPanelGUIGui;
import fr.sinikraft.magicwitchcraft.MagicWitchcraftModElements;

@MagicWitchcraftModElements.ModElement.Tag
public class SolarPanelBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:solarpanel")
	public static final Block block = null;
	@ObjectHolder("magic_witchcraft:solarpanel")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SolarPanelBlock(MagicWitchcraftModElements instance) {
		super(instance, 45);
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.create(0D, 0D, 0D, 1D, 0.3125D, 1D).withOffset(offset.x, offset.y, offset.z);
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 120);
		}
