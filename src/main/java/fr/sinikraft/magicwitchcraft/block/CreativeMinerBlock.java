...
import fr.sinikraft.magicwitchcraft.procedures.CreativeMinerOnBlockRightClickedProcedure;
...
public class CreativeMinerBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:creativeminer")
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				CreativeMinerOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
