...
public class BlockSpectralFire extends ElementsMagicWitchcraft.ModElement {
	@GameRegistry.ObjectHolder("magic_witchcraft:spectralfire")
	public static final Block block = null;
	public BlockSpectralFire(ElementsMagicWitchcraft instance) {
		super(instance, 290);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("spectralfire"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("magic_witchcraft:spectralfire", "inventory"));
	}
