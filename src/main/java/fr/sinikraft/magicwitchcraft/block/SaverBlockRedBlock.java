...
public class SaverBlockRedBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:saverblockred")
	public static final Block block = null;
	public SaverBlockRedBlock(MagicWitchcraftModElements instance) {
		super(instance, 357);
	}
