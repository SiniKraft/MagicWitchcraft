...
import fr.sinikraft.magicwitchcraft.procedures.AutoExplodeTNTBlockAddedProcedure;
import fr.sinikraft.magicwitchcraft.itemgroup.MagicWitchCraftItemGroup;
import fr.sinikraft.magicwitchcraft.MagicWitchcraftModElements;

@MagicWitchcraftModElements.ModElement.Tag
public class AutoExplodeTNTBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:autoexplodetnt")
	public static final Block block = null;
	public AutoExplodeTNTBlock(MagicWitchcraftModElements instance) {
		super(instance, 76);
	}
