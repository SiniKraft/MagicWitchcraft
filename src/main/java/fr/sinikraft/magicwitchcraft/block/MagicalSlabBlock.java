...
public class MagicalSlabBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicalslab")
	public static final Block block = null;
	public MagicalSlabBlock(MagicWitchcraftModElements instance) {
		super(instance, 33);
	}
