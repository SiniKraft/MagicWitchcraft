...
public class DeadLogBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:deadlog")
	public static final Block block = null;
	public DeadLogBlock(MagicWitchcraftModElements instance) {
		super(instance, 303);
	}
