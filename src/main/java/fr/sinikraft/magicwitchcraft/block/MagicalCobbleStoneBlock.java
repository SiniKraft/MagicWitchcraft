...
public class MagicalCobbleStoneBlock extends MagicWitchcraftModElements.ModElement {
	@ObjectHolder("magic_witchcraft:magicalcobblestone")
	public static final Block block = null;
	public MagicalCobbleStoneBlock(MagicWitchcraftModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magicalcobblestone");
		}
