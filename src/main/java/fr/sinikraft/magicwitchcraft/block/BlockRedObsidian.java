...
public class BlockRedObsidian extends ElementsMagicWitchcraft.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("redobsidian"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("redobsidian");
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureRedObsidianBlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onBlockDestroyedByExplosion(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureRedObsidianBlockDestroyedByExplosion.executeProcedure($_dependencies);
			}
		}
	}
}
