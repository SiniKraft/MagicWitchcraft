 ...
 *
 *    Keep the ElementsMagicWitchcraft object in this class and all calls to this object
...
public class MagicWitchcraft {
	...
	public static final String VERSION = "release_1.1";
	...
	@Mod.Instance(MODID)
	public static MagicWitchcraft instance;
	public ElementsMagicWitchcraft elements = new ElementsMagicWitchcraft();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsMagicWitchcraft.GuiHandler());
