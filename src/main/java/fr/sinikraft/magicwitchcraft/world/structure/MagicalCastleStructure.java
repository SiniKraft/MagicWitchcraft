...
public class MagicalCastleStructure extends MagicWitchcraftModElements.ModElement {
	public MagicalCastleStructure(MagicWitchcraftModElements instance) {
		super(instance, 270);
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("magic_witchcraft", "magicaldimension"));
						if (template == null)
							return false;
