...
public class MysteriousTowerStructure extends MagicWitchcraftModElements.ModElement {
	public MysteriousTowerStructure(MagicWitchcraftModElements instance) {
		super(instance, 92);
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("magic_witchcraft", "mysterious_tower"));
						if (template == null)
							return false;
