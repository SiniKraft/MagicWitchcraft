...
public class StructureMagicalCastle extends ElementsMagicWitchcraft.ModElement {
	public StructureMagicalCastle(ElementsMagicWitchcraft instance) {
		super(instance, 270);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (dimID == WorldMagicalDimension.DIMID) {
			...
			isNetherType = WorldMagicalDimension.NETHER_TYPE;
		}
